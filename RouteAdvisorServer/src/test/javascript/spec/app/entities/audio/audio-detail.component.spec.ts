...
describe('Component Tests', () => {
    ...
    describe('Audio Management Detail Component', () => {
        ...
        beforeEach(async(() => {
            ...
            }).overrideComponent(AudioDetailComponent, {
                set: {
                    template: ''
                }
            }).compileComponents();
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new Audio('aaa')));
            ...
            expect(comp.audio).toEqual(jasmine.objectContaining({id:'aaa'}));
            });
        });
    });
